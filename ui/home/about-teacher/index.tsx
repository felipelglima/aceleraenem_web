...
function AboutTeacherLeft({ children }: PropsWithChildren) {
  return (
    <Div className="flex w-full flex-col gap-6 px-2 lg:px-0">
      ...
      <p className="text-zinc-600">
        A professora Dulce Gomes atua há mais de 25 anos na Área de Educação.
        Graduada em Letras pela UNIP - Universidade Paulista em São Paulo, Pós
        Graduada em Neuropsicologia da Educação e Certificada em Curso Avançado
        para Corretores de Redação.
      </p>
      ...
      <p className="text-zinc-600">
        Atualmente, dedica-se exclusivamente ao curso que fundou em 2022, possui
        uma das maiores comunidades na área da educação que vem crescendo no
        Brasil, na qual ensina o processo da escrita com passo a passo para
        escrever uma redação com as 5 competências exigidas Pelo Enem - Exame
  ...
  return (
    <Div className="relative w-full shrink-0 lg:!h-[765px] lg:!w-[430px]">
      ...
      <video
        controls
        id={VIDEO_ELEMENT_ID}
        className="video-player hidden lg:h-[765px] lg:w-[430px]"
      >
...
export function AboutTeacherCard() {
  return (
    <section
      id="a-professora"
