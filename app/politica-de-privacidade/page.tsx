  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 p-4">
      <h1 className="text-3xl font-bold text-gray-900">
        Política de Privacidade - Acelera Enem
      </h1>

      <p className="text-gray-700">
        Acelera Enem leva a sua privacidade a sério e zela pela segurança e
        proteção de dados de todos os seus clientes, parceiros, fornecedores e
        usuários do site domínio https://www.aceleraenem.com e qualquer outro
        site, loja ou aplicativo operado pelo lojista.
      </p>
      ...
      <p className="text-gray-700">
        AO ACESSAR A LOJA, ENVIAR COMUNICAÇÕES OU FORNECER QUALQUER TIPO DE DADO
      ...
      <p className="text-gray-700">
        ...
        de privacidade e das escolhas que você pode fazer, bem como direitos que
        você pode exercer em relação aos Dados Pessoais tratados por nós. Se
        você tiver alguma dúvida sobre o uso de Dados Pessoais, entre em contato
        com contato@aceleraenem.com.
      </p>
      ...
      <p className="text-gray-700">
        ...
        representações sobre sites de terceiros ou suas práticas de privacidade,
        que podem ser diferentes das nossas. Recomendamos que você revise a
        política de privacidade de qualquer site com o qual você interaja antes
        de permitir a coleta e o uso de seus Dados Pessoais.
      </p>
      ...
      <h2 className="text-3xl font-bold text-gray-900">Seção 1 - Definições</h2>
      ...
      <p className="text-gray-700">No contato a loja, nós podemos coletar:</p>
      ...
      <p className="text-gray-700">
        ...
        Dados Pessoais de diversas formas, incluindo, entre outros:
      </p>
      ...
      <ol className="mt-4 list-inside list-decimal">
        ...
        <li>
          ...
          definições que escolher podem afetar a sua experiência de navegação e
      ...
      <ol className="mt-4 list-inside list-decimal">
        <li>
          Essenciais: estes cookies permitem que você navegue pelo site e
          desfrute de recursos essenciais com segurança. Um exemplo são os
          cookies de segurança, que autenticam os usuários, protegem os seus
          dados e evitam a criação de logins fraudulentos.
        </li>

        <li>
          Analíticos: os cookies desta categoria coletam informações de forma
        ...
        <li>
          Funcionais: estes cookies são utilizados para lembrar definições de
          preferências do usuário com o objetivo de melhorar a sua visita no
        ...
        <li>
          Marketing: utilizamos cookies com o objetivo de criar campanhas
      ...
      <p className="text-gray-700">
        ...
        satisfeito, além de que nós poderemos não conseguir atendê-lo por conta
      ...
      <p className="text-gray-700">
        ...
        Dados Pessoais para esses sites.
      </p>
      ...
      <p className="text-gray-700">
        ...
        qualquer outro desenvolvedor de software ou provedor de aplicativo, loja
        de mídia social, sistema operacional, prestador de serviços de internet
        sem fio ou fabricante de dispositivos, incluindo todos os Dados Pessoais
        que divulgar para outras organizações por meio dos aplicativos,
        relacionadas a tais aplicativos, ou publicadas em nossas páginas em
        mídias sociais. Nós recomendamos que você se informe sobre a política de
        privacidade de cada site visitado ou de cada prestador de serviço
        utilizado.
      </p>
      ...
      <p className="text-gray-700">
        ...
        na loja, com a data de revisão atualizada. Podemos alterar esta Política
      ...
      <p className="text-gray-700">
        ...
        se de outra forma requerido por lei ou ordem judicial. Sua utilização da
        loja após as alterações significa que aceitou as Políticas de
        Privacidade revisadas. Caso, após a leitura da versão revisada, você não
        esteja de acordo com seus termos, favor encerrar o acesso à loja.
      </p>
      ...
      <p className="text-gray-700">
        Nosso negócio é hospedado na plataforma Wix.com. O Wix.com nos fornece
        uma plataforma online que nos permite vender produtos e serviços para
        nossos clientes. As suas informações podem ser armazenadas no banco de
        dados do Wix.com. O Wix.com armazena as suas informações em servidores
        seguros por firewall.
      </p>

      <p className="text-gray-700">
        Todas as entradas de pagamento direto oferecidas pelo Wix.com e usados
        por nossa empresa aderem aos padrões definidos pelo PCI-DSS, gerenciados
        pelo PCI Security Standards Council, que é um esforço conjunto de marcas
        como Visa, MasterCard, American Express e Discover. Os requisitos do
        PCI-DSS ajudam a garantir o manuseio seguro das informações de cartão de
        crédito pela nossa loja e seus provedores de serviços.
      </p>
      ...
      <p className="text-gray-700">
        ...
        Tratamento de seus Dados Pessoais, favor contatar-nos em
        contato@aceleraenem.com.
      </p>
    </div>
  )
}
